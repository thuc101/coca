<template>
    <b-container fluid>
        ...
        <raw-loader v-show="level == 9" :mytxt="require('!raw-loader!./TableProviderChi.vue').default"
            :btnText="`Code TableProviderChi [${level}]`"></raw-loader>
        ...
        <b-table 
            ...
            <template v-slot:cell()="{ value, item, field: { key } }">
                ...
                <template v-if="(sel.Id == item.Id || item.Id == 0)">
                    ...
                    <template v-else-if=" key=='TienChi' ">
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: 'TienChi', label: 'Tiền Chi', class: "text-center", sortable: true, thClass: "text-center", tdClass: "align-middle", thStyle: { width: "10%" }  },
